...
async function main() {
  const call = await client.calls.create({
    ...
    startedAt: '2025-02-04T21:31:24.292Z',
  });
...
await client.calls.create({ direction: 'INBOUND', sourceRecordingUrl: 'https://example.com/recording.mp3', startedAt: '2025-02-04T21:31:24.292Z' }, {
  maxRetries: 5,
});
```
