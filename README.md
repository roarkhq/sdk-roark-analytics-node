...
async function main() {
  const call = await client.calls.create({
    ...
    startedAt: '2025-02-04T23:04:50.734Z',
  });
...
await client.calls.create({ direction: 'INBOUND', sourceRecordingUrl: 'https://example.com/recording.mp3', startedAt: '2025-02-04T23:04:50.734Z' }, {
  maxRetries: 5,
});
```
