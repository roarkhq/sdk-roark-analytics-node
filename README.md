...
async function main() {
  const call = await client.calls.create({
    ...
    startedAt: '2025-02-04T23:37:00.465Z',
  });
...
await client.calls.create({ direction: 'INBOUND', sourceRecordingUrl: 'https://example.com/recording.mp3', startedAt: '2025-02-04T23:37:00.465Z' }, {
  maxRetries: 5,
});
```
