...
async function main() {
  const call = await client.calls.create({
    ...
    startedAt: '2025-02-04T09:15:50.780Z',
  });
...
await client.calls.create({ direction: 'INBOUND', sourceRecordingUrl: 'https://example.com/recording.mp3', startedAt: '2025-02-04T09:15:50.780Z' }, {
  maxRetries: 5,
});
```
