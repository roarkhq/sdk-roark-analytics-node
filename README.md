...
async function main() {
  const callAnalysis = await client.callAnalysis.create({
    ...
    startedAt: '2025-03-01T05:33:56.870Z',
  });
...
await client.callAnalysis.create({ callDirection: 'INBOUND', interfaceType: 'PHONE', participants: [{ role: 'AGENT' }, { role: 'AGENT' }], recordingUrl: 'https://example.com/recording.wav', startedAt: '2025-03-01T05:33:56.870Z' }, {
  maxRetries: 5,
});
```
