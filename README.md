...
async function main() {
  const callAnalysis = await client.callAnalysis.create({
    ...
    startedAt: '2025-02-07T09:19:41.066Z',
  });
...
await client.callAnalysis.create({ direction: 'INBOUND', sourceRecordingUrl: 'https://example.com/recording.mp3', startedAt: '2025-02-07T09:19:41.066Z' }, {
  maxRetries: 5,
});
```
