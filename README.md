...
async function main() {
  const call = await client.calls.create({
    ...
    startedAt: '2025-02-04T12:49:14.964Z',
  });
...
await client.calls.create({ direction: 'INBOUND', sourceRecordingUrl: 'https://example.com/recording.mp3', startedAt: '2025-02-04T12:49:14.964Z' }, {
  maxRetries: 5,
});
```
