import fs from 'fs';
import type { ResponseLike } from '@roarkanalytics/sdk/internal/to-file';
import { toFile } from '@roarkanalytics/sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@roarkanalytics/sdk/core/uploads');
    await expect(
