...
export const COMMANDS: readonly CliCommand[] = [
  ...
  {
    commandPath: ['call', 'evaluation-run', 'list'],
    clientProperty: 'call',
  ...
  },
  {
    ...
    description: 'Create a new chat with segments (messages and tool invocations)',
    positionals: [],
    flags: [
      {
        ...
        location: 'body',
        required: true,
        description: 'When the chat started (ISO 8601 format)',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'When the chat ended (ISO 8601 format)',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'Ordered list of messages exchanged during the chat',
        valueKind: 'array',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'List of tool invocations made during the chat',
        valueKind: 'array',
        repeatable: false,
      },
      {
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Optional OpenTelemetry trace ID for the chat. Surfaces the chat in the tracing tab.',
        valueKind: 'string',
        repeatable: false,
      },
      {
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Label to identify this customer in the chat (e.g., "user-01", "anonymous-visitor")',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        required: true,
        description:
          'Customer phone number in E.164 format (e.g., +14155551234), optional for chat customers',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Customers participating in the chat.',
        valueKind: 'array',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['chat', 'get'],
    clientProperty: 'chat',
    methodName: 'getByID',
    httpMethod: 'get',
    httpPath: '/v1/chat/{id}',
    summary: 'Get a chat by ID',
    description: 'Retrieve an existing chat by its unique identifier',
    positionals: [
      {
        name: 'chat-id',
        paramKey: 'id',
  ...
  {
    commandPath: ['chat', 'list'],
    clientProperty: 'chat',
    methodName: 'list',
    httpMethod: 'get',
    httpPath: '/v1/chat',
    summary: 'List chats',
    description: 'Returns a paginated list of chats for the authenticated project.',
    positionals: [],
    flags: [
      {
        name: 'limit',
      ...
      },
      {
        ...
        description: 'Field to sort by (default: createdAt)',
        valueKind: 'string',
        enumValues: ['createdAt', 'startTimestamp', 'endTimestamp', 'duration', 'title'],
        repeatable: false,
      },
      {
        name: 'sort-direction',
      ...
      },
      {
        ...
        location: 'query',
        required: false,
        description: 'Search text to filter chats by id, title, summary, message text, or note content',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'query',
        required: false,
        description: 'Filter by simulation run plan job ID to get all chats from a specific simulation batch',
        valueKind: 'string',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['chat', 'metric', 'list'],
    clientProperty: 'chat',
    methodName: 'listMetrics',
    httpMethod: 'get',
    httpPath: '/v1/chat/{id}/metrics',
    summary: 'List chat metrics',
    description:
  ...
  {
    commandPath: ['chat', 'transcript', 'get'],
    clientProperty: 'chat',
    methodName: 'getTranscript',
    httpMethod: 'get',
    httpPath: '/v1/chat/{id}/transcript',
    summary: 'Get chat transcript',
    description: 'Fetch the full transcript (messages) for a specific chat.',
    positionals: [
      {
        name: 'chat-id',
        paramKey: 'id',
    ...
    bodyVariants: [
      {
        ...
        required: ['type', 'title', 'agentIds', 'graph'],
      },
      {
  ...
  },
  {
    ...
    flags: [
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Replaces the linked agents. Omit to leave them unchanged.',
        valueKind: 'array',
        repeatable: true,
      },
      {
  ...
  {
    commandPath: ['simulation', 'scenario', 'create'],
    clientProperty: 'simulationScenario',
    methodName: 'create',
    httpMethod: 'post',
    ...
    flags: [
      {
        ...
        location: 'body',
        required: true,
        description: 'Name of the scenario (used as the START node content)',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'Ordered list of steps for the scenario (at least one step is required)',
        valueKind: 'array',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['simulation', 'scenario', 'delete'],
    clientProperty: 'simulationScenario',
    methodName: 'delete',
    httpMethod: 'delete',
  ...
  {
    commandPath: ['simulation', 'scenario', 'get'],
    clientProperty: 'simulationScenario',
    methodName: 'getByID',
    httpMethod: 'get',
    httpPath: '/v1/simulation/scenario/{scenarioId}',
  ...
  {
    commandPath: ['simulation', 'scenario', 'list'],
    clientProperty: 'simulationScenario',
    methodName: 'list',
    httpMethod: 'get',
    httpPath: '/v1/simulation/scenario',
  ...
  {
    commandPath: ['simulation', 'scenario', 'update'],
    clientProperty: 'simulationScenario',
    methodName: 'update',
    httpMethod: 'put',
    httpPath: '/v1/simulation/scenario/{scenarioId}',
    ...
    flags: [
      {
        ...
        location: 'body',
        required: false,
        description: 'New name for the scenario (updates the START node content)',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'List of step changes to apply to the scenario',
        valueKind: 'array',
        repeatable: false,
      },
    ],
