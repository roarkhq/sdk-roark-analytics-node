...
export const sdkMethods: SdkMethod[] = [
  ...
  },
  {
    ...
    fullyQualifiedName: 'simulationEnvironment.getByID',
    httpMethod: 'get',
    httpPath: '/v1/simulation/environment/{environmentId}',
  },
  {
    clientCallName: 'client.simulationCustomerFlow.create',
    fullyQualifiedName: 'simulationCustomerFlow.create',
    httpMethod: 'post',
    httpPath: '/v1/simulation/customer-flow',
  },
  {
    clientCallName: 'client.simulationCustomerFlow.update',
    fullyQualifiedName: 'simulationCustomerFlow.update',
    httpMethod: 'put',
    httpPath: '/v1/simulation/customer-flow/{flowId}',
  },
  {
    clientCallName: 'client.simulationCustomerFlow.list',
    fullyQualifiedName: 'simulationCustomerFlow.list',
    httpMethod: 'get',
    httpPath: '/v1/simulation/customer-flow',
  },
  {
    clientCallName: 'client.simulationCustomerFlow.delete',
    fullyQualifiedName: 'simulationCustomerFlow.delete',
    httpMethod: 'delete',
    httpPath: '/v1/simulation/customer-flow/{flowId}',
  },
  {
    clientCallName: 'client.simulationCustomerFlow.getByID',
  ...
  },
  {
    ...
    httpMethod: 'post',
    httpPath: '/v1/simulation/customer-flow/{flowId}/variant',
  },
  {
    clientCallName: 'client.simulationCustomerFlowVariant.update',
    fullyQualifiedName: 'simulationCustomerFlowVariant.update',
    httpMethod: 'put',
    httpPath: '/v1/simulation/customer-flow/{flowId}/variant/{variantId}',
  },
  {
    clientCallName: 'client.simulationCustomerFlowVariant.list',
    fullyQualifiedName: 'simulationCustomerFlowVariant.list',
    httpMethod: 'get',
    httpPath: '/v1/simulation/customer-flow/{flowId}/variant',
  },
  {
    clientCallName: 'client.simulationCustomerFlowVariant.delete',
    fullyQualifiedName: 'simulationCustomerFlowVariant.delete',
    httpMethod: 'delete',
    httpPath: '/v1/simulation/customer-flow/{flowId}/variant/{variantId}',
  },
  {
    clientCallName: 'client.simulationCustomerFlowVariant.getByID',
    fullyQualifiedName: 'simulationCustomerFlowVariant.getByID',
    httpMethod: 'get',
    httpPath: '/v1/simulation/customer-flow/{flowId}/variant/{variantId}',
  },
  {
    clientCallName: 'client.simulationCustomerFlowVariant.setDefault',
    fullyQualifiedName: 'simulationCustomerFlowVariant.setDefault',
    httpMethod: 'post',
    httpPath: '/v1/simulation/customer-flow/{flowId}/variant/{variantId}/default',
  },
  {
