...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.customerFlow.update',
    fullyQualifiedName: 'customerFlow.update',
    httpMethod: 'put',
    httpPath: '/v1/customer-flow/{flowId}',
  },
  {
    clientCallName: 'client.customerFlow.list',
    fullyQualifiedName: 'customerFlow.list',
    httpMethod: 'get',
    httpPath: '/v1/customer-flow',
  },
  {
    clientCallName: 'client.customerFlow.delete',
  ...
  },
  {
    ...
    fullyQualifiedName: 'customerFlow.getByID',
    httpMethod: 'get',
    httpPath: '/v1/customer-flow/{flowId}',
  },
  {
    clientCallName: 'client.customerFlow.replaceGraph',
    fullyQualifiedName: 'customerFlow.replaceGraph',
    httpMethod: 'put',
    httpPath: '/v1/customer-flow/{flowId}/graph',
  },
  {
    clientCallName: 'client.customerFlow.updateHappyPath',
    fullyQualifiedName: 'customerFlow.updateHappyPath',
    httpMethod: 'put',
    httpPath: '/v1/customer-flow/{flowId}/happy-path',
  },
  {
    clientCallName: 'client.customerFlowEdgeCase.update',
    fullyQualifiedName: 'customerFlowEdgeCase.update',
    httpMethod: 'put',
    httpPath: '/v1/customer-flow/{flowId}/edge-case/{edgeCaseId}',
  },
  {
    clientCallName: 'client.customerFlowEdgeCase.add',
    fullyQualifiedName: 'customerFlowEdgeCase.add',
    httpMethod: 'post',
    httpPath: '/v1/customer-flow/{flowId}/edge-case',
  },
  {
    clientCallName: 'client.customerFlowEdgeCase.promote',
    fullyQualifiedName: 'customerFlowEdgeCase.promote',
    httpMethod: 'post',
    httpPath: '/v1/customer-flow/{flowId}/edge-case/{edgeCaseId}/promote',
  },
  {
    clientCallName: 'client.customerFlowEdgeCase.remove',
    fullyQualifiedName: 'customerFlowEdgeCase.remove',
    httpMethod: 'delete',
    httpPath: '/v1/customer-flow/{flowId}/edge-case/{edgeCaseId}',
  },
  {
