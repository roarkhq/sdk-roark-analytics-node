...
const fuse = new Fuse(
  [
    ...
    'client.simulationCustomerFlowVariant.getByID',
    'client.simulationCustomerFlowVariant.list',
    'client.simulationCustomerFlowVariant.setDefault',
    'client.simulationCustomerFlowVariant.update',
    'client.agent.create',
