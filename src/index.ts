...
export class Roark extends Core.APIClient {
   ...
   * @param {string} [opts.baseURL=process.env['ROARK_BASE_URL'] ?? https://customer.api.roark.ai/v1] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      bearerToken,
      ...opts,
      baseURL: baseURL || `https://customer.api.roark.ai/v1`,
    };
